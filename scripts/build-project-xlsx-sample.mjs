...
const excelIoWorksheetBuildCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io-worksheet-build.js"), "utf8");
const excelIoWorksheetParseCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io-worksheet-parse.js"), "utf8");
const excelIoWorkbookParseCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io-workbook-parse.js"), "utf8");
const excelIoWorkbookBuildCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io-workbook-build.js"), "utf8");
const excelIoStylesBuildCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io-styles-build.js"), "utf8");
const excelIoStylesParseCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io-styles-parse.js"), "utf8");
const excelIoCode = fs.readFileSync(path.resolve(ROOT, "src/js/excel-io.js"), "utf8");
const msProjectAiViewsCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-ai-views.js"), "utf8");
const msProjectCalendarCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-calendar.js"), "utf8");
const msProjectSamplesCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-samples.js"), "utf8");
const msProjectCsvCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-csv.js"), "utf8");
const msProjectValidateHelpersCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-validate-helpers.js"), "utf8");
const msProjectValidateCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-validate.js"), "utf8");
const msProjectXmlDomCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-xml-dom.js"), "utf8");
const msProjectCodecCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-codec.js"), "utf8");
const msProjectMermaidCode = fs.readFileSync(path.resolve(ROOT, "src/js/msproject-mermaid.js"), "utf8");
...
const projectXlsxImportUtilCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-import-util.js"), "utf8");
const projectXlsxImportProjectCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-import-project.js"), "utf8");
const projectXlsxImportCalendarsCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-import-calendars.js"), "utf8");
const projectXlsxImportEntitiesCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-import-entities.js"), "utf8");
const projectXlsxImportCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-import.js"), "utf8");
const projectXlsxExportUtilCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-export-util.js"), "utf8");
const projectXlsxExportProjectCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-export-project.js"), "utf8");
const projectXlsxExportEntitiesCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-export-entities.js"), "utf8");
const projectXlsxExportCalendarsCode = fs.readFileSync(path.resolve(ROOT, "src/js/project-xlsx-export-calendars.js"), "utf8");
