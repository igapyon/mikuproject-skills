...
(() => {
    ...
    function applyUpdateAssignmentOperation(assignment, rawFields, project, changes, warnings, operationIndex) {
        ...
        if (startTouched && assignment.start !== nextStart) {
            changes.push({ scope: "assignments", uid: assignment.uid, label: assignment.uid, field: "start", before: assignment.start, after: nextStart });
            assignment.start = nextStart;
        }
        if (finishTouched && assignment.finish !== nextFinish) {
            changes.push({ scope: "assignments", uid: assignment.uid, label: assignment.uid, field: "finish", before: assignment.finish, after: nextFinish });
    ...
    globalThis.__mikuprojectProjectPatchJsonUpdates = {
