...
- 掲載先: Qiita
- 公開記事タイトル: [mikuproject] Agent Skills で WBS の叩き台作成とブラッシュアップ
- URL: https://qiita.com/igapyon/items/3736cc2ea348cb3ee63b
- スクリーンショット挿入: Qiita に直接アップロード方式

## Qiita 掲載用属性情報

- タイトル: [mikuproject] Agent Skills で WBS の叩き台作成とブラッシュアップ
- タグ: `mikuproject`, `mikuku`, `AgentSkills`, `WBS`, `生成AI`
...
- [mikuproject] 生成AIと一緒にWBSの叩き台を作る計画策定の試み
  - https://qiita.com/igapyon/items/76122bebc9847575d0c7
- [mikuproject] WBS 関連資料を XLSX / Markdown / SVG などで扱える OSSツールを作った
