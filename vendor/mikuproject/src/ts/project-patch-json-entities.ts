...
(() => {
  ...
  function applyAddResourceOperation(
    ...
    const addedResource: ResourceModel = {
      ...
      standardRate: operation.standard_rate?.trim() || undefined,
      overtimeRate: operation.overtime_rate?.trim() || undefined,
  ...
  function applyDeleteCalendarOperation(
    ...
    if (projectRef || taskRefs.length > 0 || resourceRefs.length > 0 || baseCalendarRefs.length > 0) {
      ...
      if (projectRef) blockers.push("project=1");
      if (taskRefs.length > 0) blockers.push(`tasks=${taskRefs.join(", ")}`);
      if (resourceRefs.length > 0) blockers.push(`resources=${resourceRefs.join(", ")}`);
      if (baseCalendarRefs.length > 0) blockers.push(`baseRefs=${baseCalendarRefs.join(", ")}`);
  ...
  (globalThis as typeof globalThis & {
    __mikuprojectProjectPatchJsonEntities?: {
      warnUnsupportedPatchKeys: typeof warnUnsupportedPatchKeys;
      warnUnsupportedPatchKeysForScope: typeof warnUnsupportedPatchKeysForScope;
      applyAddAssignmentOperation: typeof applyAddAssignmentOperation;
      applyAddResourceOperation: typeof applyAddResourceOperation;
      applyAddCalendarOperation: typeof applyAddCalendarOperation;
      applyDeleteResourceOperation: typeof applyDeleteResourceOperation;
      applyDeleteCalendarOperation: typeof applyDeleteCalendarOperation;
      applyDeleteAssignmentOperation: typeof applyDeleteAssignmentOperation;
    };
  }).__mikuprojectProjectPatchJsonEntities = {
