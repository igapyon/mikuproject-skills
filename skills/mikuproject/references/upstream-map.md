...
Check the bundled `runtime/mikuproject` location first when available.

## Stable API Entry Points

- `skills/mikuproject/runtime/mikuproject/src/ts/ai-json-spec.ts`
...
- `skills/mikuproject/runtime/mikuproject/src/ts/core-api.ts`
  - bundled install location
...
- `skills/mikuproject/runtime/mikuproject/docs/mikuproject-ai-json-spec.md`
  - bundled install location
...
- `skills/mikuproject/runtime/mikuproject/src/ts/ai-json-util.ts`
  - bundled install location
